...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 1051200000;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = -1; // November 15th, 2017.
        ...
        genesis = CreateGenesisBlock(1541516400, 2566882, 0x1e0fffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("00000c1548669a266c565560c8fe0e46856e2ee89c279b5ecb653ae6fce94815"));
        assert(genesis.hashMerkleRoot == uint256S("b17fe30ba63b667e32068143cd39f117c62b10e7fcc267e92c84b40c02b58fbb"));
...
//        vSeeds.emplace_back("seed.bitcoin.sprovoost.nl"); // Sjors Provoost
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31); // D
        ...
        checkpointData = {
            {
                {1, uint256S("000009bb0fc1575df78197f446505c23aa2b61d16bf936eae576ecf28956e75a")},
                {25, uint256S("00000714933383bb34373b444d9b56bd7909f7caf3a477b9e25f2a7ec75849d1")},
            }
        };
