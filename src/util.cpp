...
const char * const BITCOIN_PID_FILENAME = "dongrid.pid";
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Dongri Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Dongri Core developers";
    }
